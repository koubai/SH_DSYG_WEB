		...
		<table style="margin-left: 50px; margin-top: 30px;" border="0" cellspacing="15" cellpadding="0">
			...
			<tr>
				...
				<td>
					<div class="box1_left"></div>
					<div class="box1_center">
						<input type="text" id="tmpnewsdate" style="width:285px;" disabled="disabled" value="<s:property value="updNewsDto.newsdate"/>"/>
				...
				<td>
					...
					<div class="box1_center">
						...
						<s:if test='updNewsDto.pic01 != null && updNewsDto.pic01 != ""'>
							<img src="<s:property value="updNewsDto.newsPicUrl"/><s:property value="updNewsDto.pic01"/>" alt="" />
						</s:if>
					</div>
					<div class="box1_right"></div>
				</td>
